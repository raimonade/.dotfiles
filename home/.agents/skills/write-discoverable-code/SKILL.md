...
description: Name code so plain-text search finds it — functions, types, constants, files, error messages, doc comments. Use when writing or renaming any of those.
license: MIT
---
