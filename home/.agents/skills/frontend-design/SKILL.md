...
description: Build distinctive, production-grade frontend code that avoids generic AI aesthetics. Use when creating web components, pages, artifacts, posters, or applications, or when another design skill needs project context.
