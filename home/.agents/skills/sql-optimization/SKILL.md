...
description: SQL performance tuning for MySQL, PostgreSQL, SQL Server, and Oracle. Use when a query is slow, or when reviewing execution plans, indexes, pagination, or batch operations.
---
