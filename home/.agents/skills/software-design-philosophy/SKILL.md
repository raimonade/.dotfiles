...
description: 'Ousterhout''s "A Philosophy of Software Design". Use when reducing complexity — module decomposition, interface depth, coupling, information leakage, error-handling strategy, naming, comments — or when a code review asks for design-quality feedback.'
---
